/**
 * Field-level audit mock data aligned with `src/models/obligationAudit.js`.
 *
 * Model fields: field, from, to, obligationId, obligationVersion, createdAt
 * (weak entity — no own id)
 *
 * `obligationVersion` is the obligation row version after that change (0 = creation).
 *
 * @typedef {{
 *   obligationId: number;
 *   field: string;
